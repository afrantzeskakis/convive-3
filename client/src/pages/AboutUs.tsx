          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-slate-500 mb-4 leading-relaxed">Convive was founded on a simple but powerful insight: most people never experience a restaurant at its full potential. The mystique that Anthony Bourdain showed the world, the passion that made Gordon Ramsey famous, and the grit that makes shows like "The Bear" captivating, is completely hidden from the communities they serve. The best dishes go unordered, the finest wines unpaired, and the chef's true vision unseen.</p>
                <p className="text-slate-500 mb-4 leading-relaxed">We recognized that someone who lives inside a restaurant's world for countless hours every week, who has watched the chef perfect a sauce over months, who knows why certain ingredients are sourced from certain places over others, could open a door that most diners never even know exists because they can't possibly explain such nuance on a busy Friday night.</p>
