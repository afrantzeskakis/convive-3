  ...
  const steps = [
    {
      ...
      details: "We give you a questionnaire to help us match you with the right group, so your host can focus on tailoring the evening to exactly what you'll love."
    },
    {
