  ...
  const steps = [
    {
      ...
      details: "Your preferences help us match you with the right restaurant and host. We consider cuisine interests, dietary needs, and experience level to ensure your host can guide you through exactly the kind of evening you'll love."
    },
    {
    ...
    },
    {
      ...
      description: "Reserve your place with a simple payment. Your ticket covers your seat and a welcome drink to start the evening.",
      icon: <CreditCard className="h-8 w-8 text-primary" />,
      details: "Our tiered ticket system provides access to different levels of dining experiences. From signature evenings at partner restaurants to exclusive chef's table events, choose the experience that fits your taste."
    },
    {
    ...
    },
    {
      ...
      description: "After dinner, stay in touch with your fellow guests through our platform's messaging system.",
      icon: <MessageSquare className="h-8 w-8 text-primary" />,
      details: "Great dining experiences often lead to lasting connections. Our platform allows you to stay in touch with the people you dined with, keeping messages private until both parties agree to share contact information."
    }
  ];
      ...
      <div className="bg-slate-50 rounded-lg p-8 mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col items-center text-center p-4">
            ...
            <p className="text-slate-600">
              Handpicked restaurants known for exceptional food and ambiance, selected for the quality of their craft.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center p-4">
            ...
            <p className="text-slate-600">
              Your information stays secure, and you choose whether to stay connected with fellow guests after the evening.
            </p>
          </div>
        </div>
      </div>
