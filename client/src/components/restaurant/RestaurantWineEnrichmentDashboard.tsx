  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight">AI Wine Enrichment System</h2>
      ...
      <Tabs defaultValue="upload" className="w-full">
        <TabsList className="grid w-full grid-cols-3">
          <TabsTrigger value="upload" className="flex items-center gap-1 text-xs sm:text-sm">
            ...
            <span className="hidden sm:inline">Upload & Enrich</span>
            <span className="sm:hidden">Upload</span>
          </TabsTrigger>
          <TabsTrigger value="manage" className="flex items-center gap-1 text-xs sm:text-sm">
            <Database className="w-3 h-3 sm:w-4 sm:h-4" />
            <span className="hidden sm:inline">Wine Database</span>
            <span className="sm:hidden">Wines</span>
          </TabsTrigger>
              ...
              <div className="grid gap-4 grid-cols-2 sm:grid-cols-3 lg:grid-cols-5">
                {[
                  ...
                  <div key={index} className="text-center space-y-1 sm:space-y-2">
                    ...
                    <h4 className="font-medium text-xs sm:text-sm">{item.stage}</h4>
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                      <div className="flex-1">
                        <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 mb-2">
                          <h3 className="font-semibold text-base sm:text-lg">{wine.wine_name}</h3>
                          <Badge className={`${getStatusColor(wine.enrichment_status)} border-0 w-fit`}>
                            {getStatusIcon(wine.enrichment_status)}
                            <span className="ml-1 capitalize text-xs">{wine.enrichment_status}</span>
                          </Badge>
                        </div>
                        <div className="space-y-1 text-xs sm:text-sm text-muted-foreground">
                          ...
                          <p className="sm:hidden"><strong>Type:</strong> {wine.wine_type}</p>
                          <p className="hidden sm:block"><strong>Type:</strong> {wine.wine_type}</p>
                          {wine.what_makes_special && (
                            <p className="text-xs italic mt-2 line-clamp-2 hidden sm:block">{wine.what_makes_special.substring(0, 120)}...</p>
                          )}
                        </div>
                      </div>
                        ...
                        {wine.enrichment_status === 'completed' && (
                          <Dialog>
                            <DialogTrigger asChild>
                              <Button size="default" variant="outline" className="h-9 px-3 text-sm" onClick={() => setSelectedWine(wine)}>
                              ...
                              {selectedWine && (
                                <div className="space-y-4 sm:space-y-6">
                                  <div className="grid gap-4 sm:grid-cols-2">
                                    <div>
                                      <h4 className="font-medium mb-2 text-sm sm:text-base">Wine Details</h4>
                                    ...
                                    <div>
                                      <h4 className="font-medium mb-2 text-sm sm:text-base">Restaurant Information</h4>
                                      <div className="space-y-1 text-xs sm:text-sm">
                                  ...
                                  <div className="space-y-4">
                                      ...
                                      <div>
                                        ...
                                        <div className="rounded border p-3 text-xs sm:text-sm">
                                          <div className="flex items-center gap-2">
                                            <span className="text-xl sm:text-2xl font-bold text-yellow-600">{selectedWine.wine_rating}</span>
                                    ...
                                    {selectedWine.general_guest_experience && (
                                      <div>
                                        ...
                                        <ScrollArea className="h-24 sm:h-32 rounded border p-3 text-xs sm:text-sm">
                                          {selectedWine.general_guest_experience}
                                        </ScrollArea>
                                      </div>
                                    )}
