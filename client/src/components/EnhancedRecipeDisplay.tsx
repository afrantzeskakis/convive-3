...
export function EnhancedRecipeDisplay({ analysis }: EnhancedRecipeDisplayProps) {
  ...
  return (
    <div className="space-y-6">
      {/* Recipe Content with Highlighted Terms - Original Format */}
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <ChefHat className="w-5 h-5" />
            Recipe (Click highlighted terms to learn)
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div 
            className="font-mono text-sm whitespace-pre-wrap leading-relaxed bg-gray-50 p-4 rounded-md border"
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base">
              ...
              Educational Terms Found ({analysis.highlightedTerms.length})
            </CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-xs text-gray-600 mt-3">
              Click any underlined term above in the original recipe text to open its educational carousel
            </p>
          </CardContent>
        </Card>
      )}
